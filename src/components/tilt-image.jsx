...
export default function TiltedImage({ rotateAmplitude = 3, }) {
    ...
    return (
        <motion.figure ref={ref} className="relative w-full h-full [perspective:800px] mt-8 max-w-4xl mx-auto flex flex-col items-center justify-center" onMouseMove={handleMouse} onMouseLeave={handleMouseLeave}
